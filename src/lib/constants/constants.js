...
module.exports.CSV_TEMPLATE_LOCATION = path.join(__dirname, serviceTemplateFolder, 'csv');
module.exports.CSV_DATA_LOCATION = path.join(__dirname, sampleDataFolder, 'csv');
